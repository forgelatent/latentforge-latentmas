> 📋 **[NOTE 2026-04-18 — Partial Validity]**
>
> **Technical findings in this file are VALID and reproducible:**
> - Steering vector movement (Bitcoin 35→75%, Powell 10→25%, Iran 15→35%)
> - Bearish asymmetry (residual injection unreachable at all tested layers)
> - 24x compression fidelity measurements
>
> **Baseline probability values** (e.g., "Bitcoin crowd baseline 35%") **are drawn from the synthetic `policy_markets_seed.json` baseline** invalidated on April 18. The *movement* measurements are independent of the baseline source — we measured how far the vector shifted, not whether the shifted value was correct about the world.
>
> See `docs/INCIDENT_2026-04-18.md` for full context. Any "vs crowd" framing in this file should be disregarded until live-data baselines exist (post-April 20).
