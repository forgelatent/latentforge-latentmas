...
Three agents with differentiated reasoning roles (Bayesian Updater dropped April 11, 2026 — tracked identically to Quant Researcher on 9 of 11 markets, no added signal):
...
Each agent independently estimates probability for YES outcome. Final swarm estimate = average of three agent estimates.
