...
**HEAD:** `36a6fc5` — fix(research-sweep): name every fetch failure; source-dark is a failure, not a quiet day (preceded by `2832d02`: compression-researcher fails loudly)
