...
**HEAD:** `abbcf57` — docs(ledger): dated update note. The five commits after `36a6fc5` (`082d45f`, `f24ec4c`, `f932f04`, `0eee1f8`, `abbcf57`) are records and evidence only, no code changed; the last code commits remain `36a6fc5` (research-sweep) and `2832d02` (compression-researcher).
